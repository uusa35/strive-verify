import ParticipantController from '@/actions/App/Http/Controllers/Backend/ParticipantController';
...
export default function ({ types }: SharedData) {
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        },
        {
            ...
            href: backend.participant.index().url,
        },

        {
            title: 'إنشاء مشارك',
            href: backend.participant.create().url,
        },
    ];
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={`${appName} - إنشاء مشارك `} />
            <div className="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
                <div className="grid auto-rows-min gap-4 md:grid-cols-3">
                    <h1>إنشاء مشارك جديد</h1>
                </div>
                <div className="relative min-h-[100vh] flex-1 overflow-hidden rounded-xl md:min-h-min dark:border-sidebar-border">
                    <Form
                        {...ParticipantController.store.form()}
                            ...
                            <>
                                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                                    ...
                                    <div className="grid gap-2">
                                        ...
                                        <Input id="title" type="text" autoFocus tabIndex={1} autoComplete="title" name="title" placeholder="title" />
